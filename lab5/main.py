...
def calculate_average_trip_duration(df_spark_1, df_spark_2):
    ...
    result_1.write.csv("reports/average_trip_duration_per_day_1", mode='overwrite', header=True)
    result_2.write.csv("reports/average_trip_duration_per_day_2", mode='overwrite', header=True)
...
def count_trips_per_day(df_spark_1, df_spark_2):
    ...
    result_1.write.csv("reports/trips_per_day_1", mode='overwrite', header=True)
    result_2.write.csv("reports/trips_per_day_2", mode='overwrite', header=True)
...
def popular_start_stations_per_month(df_spark_1, df_spark_2):
    ...
    result_1.write.csv("reports/popular_start_stations_per_month_1", mode='overwrite', header=True)
    result_2.write.csv("reports/popular_start_stations_per_month_2", mode='overwrite', header=True)
...
def top_stations_last_two_weeks(df_spark_1, df_spark_2):
    ...
    result_1.write.csv("reports/top_stations_last_two_weeks_1", mode='overwrite', header=True)
    result_2.write.csv("reports/top_stations_last_two_weeks_2", mode='overwrite', header=True)
...
def gender_comparison(df_spark_1, df_spark_2):
    ...
    result_2.write.csv("reports/gender_comparison_2", mode='overwrite', header=True)
...
def age_analysis(df_spark_1, df_spark_2):
    ...
    result_longest_2.write.csv("reports/top_10_longest_trips_by_age_2", mode='overwrite', header=True)
    result_shortest_2.write.csv("reports/top_10_shortest_trips_by_age_2", mode='overwrite', header=True)
